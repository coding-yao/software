...
class WaterData(models.Model):
    ...
    temperature = models.FloatField(verbose_name="水温(℃)", null=True, blank=True)
    ph = models.FloatField(verbose_name="pH", null=True, blank=True)
    oxygen = models.FloatField(verbose_name="溶解氧(mg/L)", null=True, blank=True)
    conductivity = models.FloatField(verbose_name="电导率(μS/cm)", null=True, blank=True)
    turbidity = models.FloatField(verbose_name="浊度(NTU)", null=True, blank=True)
    kmno4 = models.FloatField(verbose_name="高锰酸盐指数(mg/L)", null=True, blank=True)
    nh4 = models.FloatField(verbose_name="氨氮(mg/L)", null=True, blank=True)
    all_p = models.FloatField(verbose_name="总磷(mg/L)", null=True, blank=True)
    all_n = models.FloatField(verbose_name="总氮(mg/L)", null=True, blank=True)
    iaa_alpha = models.FloatField(verbose_name="叶绿素α(Bq/L)", null=True, blank=True)
    cells = models.FloatField(verbose_name="藻密度(个/L)", null=True, blank=True)
